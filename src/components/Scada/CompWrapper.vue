<template>
  <g :width="layout.width"
     :height="layout.height"
     :transform="gTransformStr">
    <slot></slot>
  </g>
</template>
...
<script>
  export default {
    ...
    computed: {
      gTransformStr() {
        return `translate(${this.layout.x - this.layout.offsetX * this.layout.scaleX} ${this.layout.y - this.layout.offsetY * this.layout.scaleY})
